...
import com.chen.mail.browse.ConversationListFooterView;
import com.chen.mail.browse.ToggleableItem;
...
import com.chen.mail.providers.UIProvider.ConversationListIcon;
import com.chen.mail.providers.UIProvider.FolderCapabilities;
import com.chen.mail.providers.UIProvider.FolderType;
import com.chen.mail.providers.UIProvider.Swipe;
import com.chen.mail.ui.SwipeableListView.ListItemSwipedListener;
import com.chen.mail.ui.SwipeableListView.ListItemsRemovedListener;
...
public final class ConversationListFragment extends ListFragment implements
    ...
    private final AnimatedAdapter.ConversationListListener mConversationListListener =
            new AnimatedAdapter.ConversationListListener() {
        @Override
