...
import com.chen.mail.browse.ConversationContainer;
import com.chen.mail.browse.ConversationMessage;
import com.chen.mail.browse.ConversationOverlayItem;
import com.chen.mail.browse.ConversationViewAdapter;
import com.chen.mail.browse.ConversationViewAdapter.BorderItem;
import com.chen.mail.browse.ConversationViewAdapter.MessageFooterItem;
import com.chen.mail.browse.ConversationViewAdapter.MessageHeaderItem;
import com.chen.mail.browse.ConversationViewAdapter.SuperCollapsedBlockItem;
import com.chen.mail.browse.ConversationViewHeader;
import com.chen.mail.browse.ConversationWebView;
import com.chen.mail.browse.MessageCursor;
import com.chen.mail.browse.MessageHeaderView;
import com.chen.mail.browse.ScrollIndicatorsView;
import com.chen.mail.browse.SuperCollapsedBlock;
import com.chen.mail.browse.WebViewContextMenu;
...
import com.chen.mail.ui.ConversationViewState.ExpansionState;
import com.chen.mail.utils.ConversationViewUtils;
import com.chen.mail.utils.LogTag;
import com.chen.mail.utils.LogUtils;
import com.chen.mail.utils.Utils;
import com.chen.mail.browse.MailWebView;
...
public class ConversationViewFragment extends AbstractConversationViewFragment implements
    ...
    private static ConversationContainer.OverlayPosition[] parsePositions(final String[] topArray,
            final String[] bottomArray) {
        final int len = topArray.length;
        final ConversationContainer.OverlayPosition[] positions = new ConversationContainer.OverlayPosition[len];
        for (int i = 0; i < len; i++) {
            positions[i] = new ConversationContainer.OverlayPosition(
    ...
    private void ensureContentSizeChangeListener() {
        if (mWebViewSizeChangeListener == null) {
            mWebViewSizeChangeListener = new MailWebView.ContentSizeChangeListener() {
                @Override
