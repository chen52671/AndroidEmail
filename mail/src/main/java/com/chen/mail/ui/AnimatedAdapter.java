...
import com.chen.bitmap.AltBitmapCache;
import com.chen.bitmap.BitmapCache;
import com.chen.bitmap.DecodeAggregator;
...
import com.chen.mail.browse.SwipeableConversationItemView;
...
public class AnimatedAdapter extends SimpleCursorAdapter {
    ...
    private final ConversationItemViewCoordinates.CoordinatesCache mCoordinatesCache = new ConversationItemViewCoordinates.CoordinatesCache();
