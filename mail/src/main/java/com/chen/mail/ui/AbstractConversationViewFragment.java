...
import com.chen.mail.browse.ConversationAccountController;
import com.chen.mail.browse.ConversationMessage;
import com.chen.mail.browse.MessageCursor;
import com.chen.mail.browse.MessageCursor.ConversationController;
...
import com.chen.mail.providers.ListParams;
        ...
        public void onLoadFinished(Loader<ObjectCursor<ConversationMessage>> loader,
            ...
            if (mCursor == data) {
                ...
                if (messageCursor.getCount() == 0
                        && (!UIProvider.CursorStatus.isWaitingForResults(messageCursor.getStatus())
                                || mIsDetached)) {
                    if (mUserVisible) {
                        onError();
                    } else {
