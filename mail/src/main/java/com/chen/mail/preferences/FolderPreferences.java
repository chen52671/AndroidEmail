 ...
 */
package com.chen.mail.preferences;
...
public class FolderPreferences extends VersionedPrefs {
    ...
    public Set<String> getNotificationActions(final Account account) {
        ...
        final NotificationActionUtils.NotificationActionType destructiveActionType =
                supportsArchiveRemoveLabel && !preferDelete ?
                        NotificationActionUtils.NotificationActionType.ARCHIVE_REMOVE_LABEL : NotificationActionUtils.NotificationActionType.DELETE;
        ...
        final String replyAction =
                MailPrefs.get(getContext()).getDefaultReplyAll()
                        ? NotificationActionUtils.NotificationActionType.REPLY_ALL.getPersistedValue()
                        : NotificationActionUtils.NotificationActionType.REPLY.getPersistedValue();
