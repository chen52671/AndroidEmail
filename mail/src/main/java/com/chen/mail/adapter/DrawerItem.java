...
import com.chen.mail.ui.FolderItemView;
import com.chen.mail.ui.FolderListFragment;
import com.chen.mail.utils.FolderUri;
import com.chen.mail.utils.LogTag;
import com.chen.mail.utils.LogUtils;
import com.chen.mail.ui.DrawerFragment;
...
/**
 * An element that is shown in the {@link FolderListFragment}. This class is
 * only used for elements that are shown in the {@link DrawerFragment}.
 ...
 * {@link DrawerItem#ofAccount(ControllableActivity,
        Account, int, boolean, BidiFormatter)},
 * {@link DrawerItem#ofWaitView(ControllableActivity, BidiFormatter)}, etc.
 *
