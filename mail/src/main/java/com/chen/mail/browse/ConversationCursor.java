...
import com.chen.mail.content.ThreadSafeCursorWrapper;
...
import com.chen.mail.providers.UIProvider.ConversationListQueryParameters;
import com.chen.mail.providers.UIProvider.ConversationOperations;
import com.chen.mail.ui.ConversationListFragment;
...
public final class ConversationCursor implements Cursor, ConversationCursorOperationListener,
    ...
    public void handleNotificationActions() {
        ...
        mMainThreadHandler.post(new Runnable() {
            @Override
            public void run() {
                final SparseArrayCompat<NotificationActionUtils.NotificationAction> undoNotifications =
                ...
                for (int i = 0; i < undoNotifications.size(); i++) {
                    ...
                    final boolean deleteAction = notificationAction.getNotificationActionType()
                            == NotificationActionUtils.NotificationActionType.DELETE;
