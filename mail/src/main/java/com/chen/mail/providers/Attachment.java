...
public class Attachment implements Parcelable {
    ...
    public Attachment(Cursor cursor) {
        ...
        supportsDownloadAgain = cursor.getInt(
                cursor.getColumnIndex(UIProvider.AttachmentColumns.SUPPORTS_DOWNLOAD_AGAIN)) == 1;
    ...
    public Attachment(ContentValues values) {
        ...
        previewIntentUri =
                parseOptionalUri(values.getAsString(UIProvider.AttachmentColumns.PREVIEW_INTENT_URI));
    ...
    public boolean isSavedToExternal() {
        return state == UIProvider.AttachmentState.SAVED && destination == UIProvider.AttachmentDestination.EXTERNAL;
    }
