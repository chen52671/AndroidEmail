...
public abstract class MailAppProvider extends ContentProvider
     ...
     * values with keys listed in {@link UIProvider.AccountCursorExtraKeys}
     */
    ...
    public Cursor query(Uri url, String[] projection, String selection, String[] selectionArgs,
        ...
        extras.putInt(UIProvider.AccountCursorExtraKeys.ACCOUNTS_LOADED, mAccountsFullyLoaded ? 1 : 0);
    ...
    public void onLoadComplete(Loader<Cursor> loader, Cursor data) {
        ...
        mAccountsFullyLoaded = extra.getInt(UIProvider.AccountCursorExtraKeys.ACCOUNTS_LOADED) != 0;
