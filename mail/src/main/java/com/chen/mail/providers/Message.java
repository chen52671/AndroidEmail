...
import com.chen.emailcommon.internet.MimeMessage;
...
import com.chen.emailcommon.utility.ConversionUtilities;
import com.chen.mail.ui.HtmlMessage;
...
public class Message implements Parcelable, HtmlMessage {
    ...
    public Message(Context context, MimeMessage mimeMessage, Uri emlFileUri)
        ...
        setFrom(com.chen.emailcommon.mail.Address.pack(mimeMessage.getFrom()));
        setTo(com.chen.emailcommon.mail.Address.pack(mimeMessage.getRecipients(
                com.chen.emailcommon.mail.Message.RecipientType.TO)));
        setCc(com.chen.emailcommon.mail.Address.pack(mimeMessage.getRecipients(
                com.chen.emailcommon.mail.Message.RecipientType.CC)));
        setBcc(com.chen.emailcommon.mail.Address.pack(mimeMessage.getRecipients(
                com.chen.emailcommon.mail.Message.RecipientType.BCC)));
        setReplyTo(com.chen.emailcommon.mail.Address.pack(mimeMessage.getReplyTo()));
     ...
     * {@link UIProvider.MessageColumns#ALWAYS_SHOW_IMAGES} flag set.
     *
