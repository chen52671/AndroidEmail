...
package com.chen.emailcommon.internet;

import com.chen.emailcommon.mail.Body;
import com.chen.emailcommon.mail.BodyPart;
...
public class MimeBodyPart extends BodyPart {
    ...
    public void setBody(Body body) throws MessagingException {
        this.mBody = body;
        if (body instanceof com.chen.emailcommon.mail.Multipart) {
            com.chen.emailcommon.mail.Multipart multipart =
                ((com.chen.emailcommon.mail.Multipart)body);
