...
import com.chen.email.activity.setup.AccountSettings;
import com.chen.email.provider.AccountReconciler;
import com.chen.emailcommon.Logging;
import com.chen.emailcommon.VendorPolicyLoader;
...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    private static final String ACTION_DEVICE_POLICY_ADMIN = "com.chen.email.devicepolicy";
    ...
    /**
     * Entry point for {@link com.chen.email.SecurityPolicy.PolicyAdmin}.  These will
     * simply callback to {@link
     * com.chen.email.SecurityPolicy#onDeviceAdminReceiverMessage(Context, int)}.
     */
    ...
    private void onAppUpgrade() {
        ...
        updateAccountManagerAccountsOfType("com.chen.email", protocolMap);
