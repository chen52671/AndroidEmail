...
import com.chen.email.mail.Sender;
import com.chen.email.mail.Store;
import com.chen.email.provider.AccountReconciler;
...
import com.chen.emailcommon.Api;
import com.chen.emailcommon.Logging;
import com.chen.emailcommon.TrafficFlags;
import com.chen.emailcommon.internet.MimeBodyPart;
import com.chen.emailcommon.internet.MimeHeader;
import com.chen.emailcommon.internet.MimeMultipart;
...
public abstract class EmailServiceStub extends IEmailService.Stub implements IEmailService {
    ...
    public class MessageRetrievalListenerBridge implements MessageRetrievalListener {
        ...
        @Override
        public void messageRetrieved(com.chen.emailcommon.mail.Message message) {
        }
    }
