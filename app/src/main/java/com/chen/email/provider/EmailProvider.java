...
import com.chen.common.content.ProjectionMap;
import com.chen.email.Preferences;
import com.chen.email.R;
import com.chen.email.SecurityPolicy;
import com.chen.email.service.AttachmentDownloadService;
import com.chen.email.service.EmailServiceUtils;
import com.chen.email.service.EmailServiceUtils.EmailServiceInfo;
import com.chen.email2.ui.MailActivityEmail;
import com.chen.emailcommon.Logging;
import com.chen.emailcommon.mail.Address;
import com.chen.emailcommon.provider.Account;
import com.chen.emailcommon.provider.EmailContent;
import com.chen.emailcommon.provider.EmailContent.AccountColumns;
import com.chen.emailcommon.provider.EmailContent.Attachment;
import com.chen.emailcommon.provider.EmailContent.AttachmentColumns;
import com.chen.emailcommon.provider.EmailContent.Body;
import com.chen.emailcommon.provider.EmailContent.BodyColumns;
import com.chen.emailcommon.provider.EmailContent.HostAuthColumns;
import com.chen.emailcommon.provider.EmailContent.MailboxColumns;
import com.chen.emailcommon.provider.EmailContent.Message;
import com.chen.emailcommon.provider.EmailContent.MessageColumns;
import com.chen.emailcommon.provider.EmailContent.PolicyColumns;
import com.chen.emailcommon.provider.EmailContent.SyncColumns;
import com.chen.emailcommon.provider.HostAuth;
import com.chen.emailcommon.provider.Mailbox;
import com.chen.emailcommon.provider.MailboxUtilities;
import com.chen.emailcommon.provider.MessageChangeLogTable;
import com.chen.emailcommon.provider.MessageMove;
import com.chen.emailcommon.provider.MessageStateChange;
import com.chen.emailcommon.provider.Policy;
import com.chen.emailcommon.provider.QuickResponse;
import com.chen.emailcommon.service.EmailServiceProxy;
import com.chen.emailcommon.service.EmailServiceStatus;
import com.chen.emailcommon.service.IEmailService;
import com.chen.emailcommon.service.SearchParams;
import com.chen.emailcommon.utility.AttachmentUtilities;
import com.chen.emailcommon.utility.Utility;
...
import com.chen.mail.providers.UIProvider.AccountCursorExtraKeys;
import com.chen.mail.providers.UIProvider.ConversationColumns;
import com.chen.mail.providers.UIProvider.ConversationPriority;
import com.chen.mail.providers.UIProvider.ConversationSendingState;
import com.chen.mail.providers.UIProvider.DraftType;
import com.chen.mail.utils.AttachmentUtils;
import com.chen.mail.utils.LogTag;
import com.chen.mail.utils.LogUtils;
import com.chen.mail.utils.MatrixCursorWithCachedColumns;
import com.chen.mail.utils.MatrixCursorWithExtra;
import com.chen.mail.utils.MimeType;
import com.chen.mail.utils.Utils;
import com.chen.mail.widget.BaseWidgetProvider;
...
public class EmailProvider extends ContentProvider {
    ...
    private static final String ACTION_NOTIFY_MESSAGE_LIST_DATASET_CHANGED =
        "com.chen.email.MESSAGE_LIST_DATASET_CHANGED";
    ...
    private MessageQuery genQueryViewMessage(String[] uiProjection, String id) {
        ...
        if (msg != null) {
            ...
            if (atts.length > 0) {
                ArrayList<com.chen.mail.providers.Attachment> uiAtts =
                        new ArrayList<com.chen.mail.providers.Attachment>();
...
//                        continue;
//                    }
                    com.chen.mail.providers.Attachment uiAtt =
                            new com.chen.mail.providers.Attachment();
                ...
                attachmentJson = com.chen.mail.providers.Attachment.toJSONArray(uiAtts);
            }
            if (msg.mDraftInfo != 0) {
    ...
    private static Attachment convertUiAttachmentToAttachment(
            com.chen.mail.providers.Attachment uiAtt, String cachedFile, long accountKey) {
    ...
    private Uri uiSaveMessage(Message msg, Mailbox mailbox, Bundle extras) {
        ...
        final List<com.chen.mail.providers.Attachment> uiAtts =
                com.chen.mail.providers.Attachment.fromJSONArray(
        ...
        for (com.chen.mail.providers.Attachment uiAtt: uiAtts) {
    ...
    private int pickFolder(Uri uri, int type, int headerId) {
        ...
        try {
            if (ac.moveToFirst()) {
                final com.chen.mail.providers.Account uiAccount =
                        new com.chen.mail.providers.Account(ac);
