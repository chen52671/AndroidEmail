 ...
 */
package com.chen.email.preferences;
...
import com.chen.mail.preferences.BasePreferenceMigrator;
        ...
        if (oldVersion < 1) {
            ...
            for (final Account account : accounts) {
                ...
                final Cursor ecAccountCursor = context.getContentResolver().query(
                        com.chen.emailcommon.provider.Account.CONTENT_URI,
                        com.chen.emailcommon.provider.Account.CONTENT_PROJECTION,
                        AccountColumns.EMAIL_ADDRESS + " = ?", new String[] { account.name },
                        null);
                final com.chen.emailcommon.provider.Account ecAccount =
                        new com.chen.emailcommon.provider.Account();
                ...
                final boolean notify = (ecAccount.getFlags()
                        & com.chen.emailcommon.provider.Account.FLAGS_NOTIFY_NEW_MAIL) != 0;
                ...
                final boolean vibrate = (ecAccount.getFlags()
                        & com.chen.emailcommon.provider.Account.FLAGS_VIBRATE) != 0;
