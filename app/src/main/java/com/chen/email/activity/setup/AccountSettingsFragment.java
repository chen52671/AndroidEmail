...
package com.chen.email.activity.setup;
...
import com.chen.email.provider.EmailProvider;
import com.chen.email.provider.FolderPickerActivity;
...
import com.chen.mail.preferences.FolderPreferences;
import com.chen.mail.providers.Folder;
import com.chen.mail.providers.UIProvider;
import com.chen.mail.ui.settings.SettingsUtils;
import com.chen.mail.utils.LogUtils;
import com.chen.mail.utils.NotificationUtils;
...
public class AccountSettingsFragment extends PreferenceFragment
    ...
    private com.chen.mail.providers.Account mUiAccount;
    ...
    public interface Callback {
        ...
        public void onEditQuickResponses(com.chen.mail.providers.Account account);
    ...
    private static class EmptyCallback implements Callback {
        ...
        @Override public void onEditQuickResponses(com.chen.mail.providers.Account account) {}
    ...
    private class LoadAccountTask extends AsyncTask<Long, Void, Map<String, Object>> {
        ...
        protected void onPostExecute(Map<String, Object> map) {
            if (!isCancelled()) {
                ...
                mUiAccount = (com.chen.mail.providers.Account) map.get(UI_ACCOUNT_KEY);
                if (account == null) {
                    mSaveOnExit = false;
                    mCallback.abandonEdit();
                } else {
    ...
    /**
     * Loads settings that are dependent on a {@link com.chen.mail.providers.Account}, which
