...
public class AccountSettingsUtils {
     ...
     */
    public static VendorPolicyLoader.Provider findProviderForDomain(Context context, String domain) {
        VendorPolicyLoader.Provider p = VendorPolicyLoader.getInstance(context).findProviderForDomain(domain);
        if (p == null) {
     ...
     * @return suitable Provider definition, or null if no match found
     */
    /*package*/ static VendorPolicyLoader.Provider findProviderForDomain(
